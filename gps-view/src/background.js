...
function createWindow() {
  ...
  win = new BrowserWindow({
    width: 800,
    height: 600,
    title: 'GPS Tracker by Jaycar Electronics',
    webPreferences: {
      // Use pluginOptions.nodeIntegration, leave this alone
      // See nklayman.github.io/vue-cli-plugin-electron-builder
      // /guide/configuration.html#node-integration for more info
...
app.on('ready', async () => {
  if (isDevelopment && !process.env.IS_TEST) {
    ...
    // for more info
    // Electron will not launch with Devtools extensions installed on Windows 10
    // with dark mode
